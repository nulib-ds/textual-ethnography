...
export function App({children}) {
  return (
    <>
      {/* TODO(design): swap in a Northwestern/NUL logo mark once approved.
          Keeping the generic Canopy mark for this scaffolding pass. */}
      <CanopyHeader logo={Logo} />
      <main>{children}</main>
      <CanopyFooter>
        <p>
          Copyright 2026 Northwestern University Libraries, MIT License. A
          Canopy IIIF Project.
        </p>
      </CanopyFooter>
    </>
